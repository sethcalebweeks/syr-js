...
describe("[Medium]", () => {
  test("Returns true for a valid solution", () => {
    expect(sudokuRowChecker(validSolution)).toBe(true);
  });
  test("Returns false for an invalid solution", () => {
    expect(sudokuRowChecker(invalidSolution)).toBe(false);
  });
});

describe("[Hard]", () => {
  test("Returns true for a valid solution", () => {
    expect(sudokuChecker(validSolution)).toBe(true);
  });
  test("Returns false for an invalid solution", () => {
    expect(sudokuChecker(invalidSolution)).toBe(false);
  });
});
